...
In Package.json, you can define a command in _scripts_. **For this project, you also run `npm run compodoc`. It will run this command `compodoc -p tsconfig.doc.json -s -r 4201`, so documentation will be available on localhost:4201 **
